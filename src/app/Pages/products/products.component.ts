...
export class ProductsComponent {
    constructor(
        ...
        private categoryService: CatogriesService,
    ...
    validatePriceInput() {
        if (this.minPrice && !this.maxPrice)
            ...
            return {
                valid: true,
                message: `Min Price Should be less then Max Price $${this.highestPrice}`,
            };
        else if (this.minPrice && this.maxPrice && this.maxPrice < this.minPrice)
            return {
                valid: true,
                message: `Max Price Should be Greater then Min Price $${this.highestPrice}`,
            };
    ...
    FilterOptions(event: any) {
        ...
        this.categories.forEach((category) => {
            if (category.name === value) {
                ...
                const ID = this.filteredOptions.find((id_category) => {
                    return id_category == category._id;
                });
                if (!ID) {
